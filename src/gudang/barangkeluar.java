...
public class barangkeluar extends javax.swing.JFrame {
    ...
    class barang_keluar extends barangkeluar{
        int id_barang_keluar, id_barang;
        String jumlah;
        Date tanggal_keluar;
        ...
        public barang_keluar() {
            ...
            this.tanggal_keluar = (Date) dctanggal.getDate();
        }
    ...
    private void tombolinputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tombolinputActionPerformed
        ...
        try {
            barang_keluar bk = new barang_keluar();
            this.stat = k.getCon().prepareStatement("insert into barang_keluar values(?,?,?,?) ");
            stat.setInt(1, 0);
            stat.setInt(2, bk.id_barang);
            stat.setString(3, bk.jumlah);
            stat.setDate(4, new java.sql.Date(bk.tanggal_keluar.getTime()));
            stat.executeUpdate();
            refreshTable();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage());
    ...
    private void tombolupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tombolupdateActionPerformed
        ...
        try {
            barang_keluar bk = new barang_keluar();
            this.stat = k.getCon().prepareStatement("update barang_keluar set id_barang=?,"
                    + "jumlah=?,tanggal_keluar=? where id_barang_keluar=?");
            stat.setInt(1, bk.id_barang);
            stat.setString(2, bk.jumlah);
            stat.setDate(3, new java.sql.Date(bk.tanggal_keluar.getTime()));
            stat.setInt(4, Integer.parseInt(textidbk.getText()));
            stat.executeUpdate();
            refreshTable();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage());
    ...
    private void tomboldeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tomboldeleteActionPerformed
        // TODO add your handling code here:
        try {
            this.stat = k.getCon().prepareStatement("delete from barang_keluar where id_barang_keluar=?");
            stat.setInt(1, Integer.parseInt(textidbk.getText()));
            stat.executeUpdate();
            refreshTable();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage());
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        // TODO add your handling code here:
        textidbk.setText(model.getValueAt(table.getSelectedRow(), 0).toString());
